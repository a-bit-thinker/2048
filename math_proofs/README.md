...
Also see `math_proofs/frontiermath_program_specs/` for one-file-per-problem programming-language encodings of all 14 FrontierMath open problems, each with a loop-proofability score.
