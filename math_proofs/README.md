...
## 7) 14 FrontierMath problems expressed as code specs

See `math_proofs/frontiermath_14_specs/` for 14 separate files (one per FrontierMath problem), each with a programming-language style specification, verifier/certificate design, and a loop-proof likelihood score.
